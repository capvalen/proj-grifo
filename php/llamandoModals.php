...
<!-- Modal para indicar que no se pudo imprimir  -->
<div class="modal fade modalSolucionImpresion" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
<div class="modal-dialog modal-sm" role="document">
	<div class="modal-content">
		<div class="modal-header-danger">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		...
		<div class="modal-body">
			<div class="container-fluid">
			<div class="row">
				<p><strong>Error!</strong> Lo sentimos, no se pudo imprimir su cuenta, los datos se guardaron bien pero la falla es en la impresión.</p>
				<p>No cierres la ventana actual, entra <a href="https://infocatsoluciones.com/problemas-de-impresion/" target='_blank'>a este link</a> para que veas una guía de como solucionar <a href="https://infocatsoluciones.com/problemas-de-impresion/" target='_blank'>Ir a la página</a></p>
			</div>
		</div>
